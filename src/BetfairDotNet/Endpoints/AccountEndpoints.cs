...
internal static class AccountEndpoints {
    internal const string BaseUrl = "https://api.betfair.com/exchange/account/json-rpc/v1";
    internal const string GetAccountDetails = "/AccountAPING/v1.0/getAccountDetails";
